...
#### Упражнения
**01.1** Реализуйте функцию `my_remove_second`, удаляющую второй элемент из списка:
...
**01.2.** Реализуйте функцию `my_last`, возвращающую последний элемент в списке:
...
**01.3.** Реализуйте функцию `my_reverse`, разворачивающую список:
...
В отличие от списков, кортежи могут содержать элементы различных типов, но имеют фиксированное количество и порядок элементов.
